        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <a
              ...
              className="glass-strong rounded-2xl p-5 sm:p-8 text-center group hover:ring-2 hover:ring-brand-500/30 transition-all duration-200"
            >
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-400/20 to-brand-600/20 flex items-center justify-center mx-auto mb-5">
              ...
              <span className="inline-flex items-center gap-1.5 mt-4 text-xs text-brand-500 group-hover:text-brand-400 font-medium transition-colors">
