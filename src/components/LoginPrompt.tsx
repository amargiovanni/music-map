        ...
        <div className="glass-strong rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 px-5 py-3 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-semibold text-sm hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-sm"
            >
